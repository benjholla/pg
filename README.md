...
- `Universe`: The high-performance, centralized registry that manages graph state and global ID generation.
- `EphemeralGraph`: The primary, transaction-safe implementation of a graph used for data processing and analysis. It operates as an isolated sandbox tied to a specific `Universe`.
