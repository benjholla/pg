...
- `Universe`: The foundational environment that owns and manages the lifecycle of all baseline graph elements.
- `EphemeralGraph`: A lightweight, transactionally isolated graph that supports creating new subgraphs through composable, set-theoretic operations.
