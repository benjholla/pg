...
- `Universe` and `EphemeralGraph`: The core, high-scale dual-polarity engine for creating graphs. The `Universe` acts as the shared baseline, and `EphemeralGraph` supports creating new subgraphs through composable, set-theoretic operations.
