...
- `Universe`: The absolute source of truth and centralized registry for a given domain, providing thread-safe, dense indexing.
- `EphemeralGraph`: A high-performance, purely set-theoretic graph implementation that acts as a disposable, mathematically isolated scratchpad over a `Universe`.
