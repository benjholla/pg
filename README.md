...
- `Universe`: The baseline architectural container.
- `EphemeralGraph`: A high-scale, isolated transaction scratchpad backed by a `Universe` that supports composable, set-theoretic operations.
