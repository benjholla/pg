...
- `Universe`: The absolute source of truth and global index for elements.
- `EphemeralGraph`: The high-scale, memory-efficient transactional graph. It supports creating new subgraphs through composable, set-theoretic operations.
