...
- `Universe`: The baseline state for a graph, maintaining dense, contiguous memory allocations.
- `EphemeralGraph`: A transactional, locally scoped projection of a `Universe`. It provides high-performance, set-theoretic subgraph operations without mutating the underlying baseline.
