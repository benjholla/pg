...
- `Universe`: The persistent, foundational storage backing a graph.
- `EphemeralGraph`: A high-speed, transactional graph sandbox that overlays a `Universe`. It supports creating new subgraphs through composable, set-theoretic operations.
