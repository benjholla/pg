...
public class DeferredNodeSet extends AbstractDeferredElementSet<Node> implements NodeSet {
    ...
    @Override
    protected NodeSet createDeferredSet(ElementSet<Node> source, Predicate<Node> predicate) {
        return new DeferredNodeSet((NodeSet) source, predicate);
    }

    @Override
    protected NodeSet materializeSet(Set<Node> materialized) {
    ...
    public NodeSet materialize() {
        return (NodeSet) super.materialize();
    }

    @Override
    public NodeSet toImmutable() {
        return (NodeSet) super.toImmutable();
    }

    @Override
    public NodeSet intersect(java.util.Collection<? extends Node> other) {
        return (NodeSet) super.intersect(other);
    }

    @Override
    public NodeSet difference(java.util.Collection<? extends Node> other) {
        return (NodeSet) super.difference(other);
    }

    @Override
    public NodeSet union(java.util.Collection<? extends Node> other) {
