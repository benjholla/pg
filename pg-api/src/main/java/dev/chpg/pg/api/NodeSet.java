...
public interface NodeSet extends ElementSet<Node> {
    ...
    @Override NodeSet toImmutable();
    @Override Optional<Node> one();
    ...
    @Override NodeSet intersect(Collection<? extends Node> other);
    @Override NodeSet difference(Collection<? extends Node> other);
    @Override NodeSet union(Collection<? extends Node> other);
}
