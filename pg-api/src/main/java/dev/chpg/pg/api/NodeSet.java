...
public interface NodeSet extends ElementSet<Node> {
    ...
    @Override
    NodeSet intersect(java.util.Collection<? extends Node> other);

    @Override
    NodeSet difference(java.util.Collection<? extends Node> other);

    @Override
    NodeSet union(java.util.Collection<? extends Node> other);
}
