...
public class DeferredEdgeSet extends AbstractDeferredElementSet<Edge> implements EdgeSet {
    ...
    @Override
    protected EdgeSet createDeferredSet(ElementSet<Edge> source, Predicate<Edge> predicate) {
        return new DeferredEdgeSet((EdgeSet) source, predicate);
    }

    @Override
    protected EdgeSet materializeSet(Set<Edge> materialized) {
    ...
    public EdgeSet materialize() {
        return (EdgeSet) super.materialize();
    }

    @Override
    public EdgeSet toImmutable() {
        return (EdgeSet) super.toImmutable();
    }

    @Override
    public EdgeSet intersect(java.util.Collection<? extends Edge> other) {
        return (EdgeSet) super.intersect(other);
    }

    @Override
    public EdgeSet difference(java.util.Collection<? extends Edge> other) {
        return (EdgeSet) super.difference(other);
    }

    @Override
    public EdgeSet union(java.util.Collection<? extends Edge> other) {
