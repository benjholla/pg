...
public interface EdgeSet extends ElementSet<Edge> {
    ...
    @Override
    EdgeSet intersect(java.util.Collection<? extends Edge> other);

    @Override
    EdgeSet difference(java.util.Collection<? extends Edge> other);

    @Override
    EdgeSet union(java.util.Collection<? extends Edge> other);
}
