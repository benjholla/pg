...
public interface EdgeSet extends ElementSet<Edge> {
    ...
    @Override EdgeSet toImmutable();
    @Override Optional<Edge> one();
    ...
    default EdgeSet materialize() {
        java.util.Set<Edge> materialized = new java.util.HashSet<>();
        for (Edge e : this) {
            materialized.add(e);
        }
    ...
    @Override EdgeSet intersect(Collection<? extends Edge> other);
    @Override EdgeSet difference(Collection<? extends Edge> other);
    @Override EdgeSet union(Collection<? extends Edge> other);
}
