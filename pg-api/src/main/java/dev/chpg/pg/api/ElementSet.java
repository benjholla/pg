 ...
 * <p>
 * <b>What it represents:</b> A distinct collection of graph elements (nodes or edges), supporting set-theoretic math and fluent filtering.
 * <p>
 * <b>Why it exists:</b> To provide a zero-allocation, functional query pipeline for graph analysis, unifying common logic between nodes and edges.
 * <p>
 * <b>When to use it:</b> Primarily as a foundational interface. Code should generally interact with the more specific {@link NodeSet} or {@link EdgeSet} interfaces.
 *
 * @param <T> the type of elements in this set, either {@link Node} or {@link Edge}
 */
