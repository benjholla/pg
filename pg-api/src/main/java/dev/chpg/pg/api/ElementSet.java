 ...
 * <p>
 * <b>When to use it:</b> Use specific subclasses (e.g., NodeSet or EdgeSet) whenever dealing with aggregate collections of elements, especially when extracting properties or executing declarative filters.
 * <p>
 * <b>Common usage patterns:</b>
 * <ul>
 * <li>Filtering elements via fluent predicates (e.g., {@code elements.withAnyTag("knows")}).</li>
