...
/**
 * A generic set for managing collections of {@link GraphElement}s.
 */
public interface ElementSet<T extends GraphElement> extends Set<T> {

    /**
     * Converts this set into an immutable snapshot.
     *
     ...
     *
     * @return a materialized, immutable set
     */
    ElementSet<T> materialize();

    /**
     * Returns a new immutable set snapshot containing elements present in both this set and the specified collection.
    ...
    /**
     * Returns a new immutable set snapshot containing elements from this set, excluding those in the specified collection.
     * @param other the collection to perform the set operation with
    ...
    /**
     * Returns a new immutable set snapshot containing all elements from this set and the specified collection.
     * @param other the collection to perform the set operation with
