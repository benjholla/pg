...
/**
 * A specialized set for managing collections of {@link GraphElement}s.
 * <p>
 ...
 * <p>
 * <b>When to use it:</b> Use {@code ElementSet} whenever dealing with aggregate collections of elements, especially when extracting properties or executing declarative filters.
 * <p>
 * <b>Common usage patterns:</b>
 * <ul>
 * <li>Filtering elements via fluent predicates.</li>
 * <li>Extracting primitive ID arrays for bulk operations.</li>
 * <li>Forcing eager materialization of deferred pipelines via {@code materialize()}.</li>
 * </ul>
 * <p>
 * <b>Important invariants:</b> {@code ElementSet} implementations may be "live" (dynamically reflecting changes in the underlying graph) or "snapshot" based.
 * <p>
 * <b>Thread safety:</b> Thread safety guarantees depend heavily on the concrete implementation. Modifying the underlying graph while iterating a live set will likely produce a {@code ConcurrentModificationException}.
 * <p>
