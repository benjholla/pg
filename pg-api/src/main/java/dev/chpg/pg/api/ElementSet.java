...
/**
 * A generic base interface for managing collections of {@link GraphElement}s.
 * <p>
 * <b>What it represents:</b> A generic collection of graph elements, supporting set-theoretic math and fluent filtering.
 * <p>
 * <b>Why it exists:</b> To provide a common abstraction for logic shared between {@link NodeSet} and {@link EdgeSet}.
 * <p>
 * <b>When to use it:</b> Primarily as an internal base type. Code should generally interact with the more specific {@link NodeSet} or {@link EdgeSet} interfaces.
 */
