...
/**
 * A generalized set for managing collections of {@link GraphElement}s.
 * <p>
 * <b>What it represents:</b> A distinct collection of graph elements (e.g., nodes or edges), supporting set-theoretic math and fluent filtering.
 * <p>
 * <b>Why it exists:</b> To abstract common logic shared by {@link NodeSet} and {@link EdgeSet} and provide a unified functional query pipeline.
 * <p>
 * <b>Important invariants:</b> Concrete interfaces (like {@link NodeSet} and {@link EdgeSet}) covariantly override these inherited methods to return their specific types, maintaining a strictly monomorphic public API surface.
 *
 * @param <T> the specific type of graph element
 */
