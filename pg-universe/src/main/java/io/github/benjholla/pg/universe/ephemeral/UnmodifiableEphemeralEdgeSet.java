...
public class UnmodifiableEphemeralEdgeSet implements EdgeSet {

    private final Collection<? extends Edge> delegate;

    public UnmodifiableEphemeralEdgeSet(Collection<? extends Edge> delegate) {
    ...
    public EdgeSet filter(String attribute) {
        EdgeSet result = new io.github.benjholla.pg.universe.ephemeral.EphemeralEdgeSet();
