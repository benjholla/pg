...
public class DirectGraphBufferTest {
    ...
    public void testEdgeReferencesNonExistentNodeId(@TempDir Path tempDir) throws IOException {
        ...
        dev.chpg.pg.api.Graph badGraph = (dev.chpg.pg.api.Graph) java.lang.reflect.Proxy.newProxyInstance(
            dev.chpg.pg.api.Graph.class.getClassLoader(),
            new Class<?>[] { dev.chpg.pg.api.Graph.class },
            handler
        );
