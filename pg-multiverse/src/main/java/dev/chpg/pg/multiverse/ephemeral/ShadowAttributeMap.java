...
/**
 * A transactional view over a Universe element's attributes.
 */
public class ShadowAttributeMap extends AbstractMap<String, AttributeValue> implements AttributeMap {
    ...
    /**
     * Constructs a new ShadowAttributeMap for a node.
    ...
    /**
     * Constructs a new ShadowAttributeMap for an edge.
     * @param transaction the ephemeral graph
