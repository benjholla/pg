...
public class UnmodifiableHeavyNodeSet implements NodeSet {

    private final Collection<? extends Node> delegate;

    public UnmodifiableHeavyNodeSet(Collection<? extends Node> delegate) {
    ...
    public NodeSet filter(String attribute) {
        NodeSet result = new io.github.benjholla.pg.heavy.HeavyNodeSet();
